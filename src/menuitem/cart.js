...
import { Button } from "../menuitem/button/button";
...
function CartItemm() {
  ...
  const addedSushis = Object.keys(items).map((key) => {
          ...
          {totalCount ? (
            ...
            <div className="cart cart--empty">
              ...
              <p>
                ...
                <br />
                Для того, чтобы заказать суши, перейди в меню заведения.
              </p>
              <img src={cartEmptyImage} alt="Empty cart" />
              <Link to="/menu" className="button button--black">
                <span>Вернуться назад</span>
              </Link>
            </div>
          )}
